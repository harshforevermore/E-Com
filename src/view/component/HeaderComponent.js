...
export default function HeaderComponent(){
    ...
    return(
      ...
      <Container fluid >
        <Navbar.Brand href="/home" style={{fontSize:'2em'}}>Shopp</Navbar.Brand>
        ...
        <Navbar.Collapse id="navbarScroll" style={{justifyContent:'space-between'}}>
          ...
          <a href="/cart" className="navbarImages">
            ...
            {
              cartDot === true ? 
              <span className="cartCounter" style={{display:'block'}}>&nbsp;</span>
              :
              <span className="cartCounter" style={{display:'none'}}>&nbsp;</span>
            }
          </a>
          <a href="/profile" className="navbarImages"><img src={require('../image/Logo/icons8-user-96.png')} alt="" title="Profile" /></a>
            {
              user?
            <Nav.Link href="/logout" className="navbarComponents">Logout</Nav.Link>
            :
              <>
